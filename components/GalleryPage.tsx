        ...
        <section className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button
                onClick={prev}
                className="w-9 h-9 rounded-full border border-zinc-700 text-zinc-300 flex items-center justify-center text-xs hover:border-white"
              >
                0
              </button>
              <button
        ...
        <section className="space-y-6">
          <div className="flex items-center justify-between">
            ...
            <p className="text-xs text-zinc-500 max-w-xs text-right">
              Use labels to quickly surface the type of work 2 fashion, beauty, bridal, editorials.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-4 md:gap-6">
            {gridShoots.map((item) => (
              <div
                key={item.id}
                className="group rounded-2xl overflow-hidden border border-zinc-800 bg-zinc-900/60 flex flex-col"
              >
